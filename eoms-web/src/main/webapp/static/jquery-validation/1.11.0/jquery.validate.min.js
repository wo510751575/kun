...
jQuery.validator.addMethod("decimal", function(value, element, param) {return this.optional(element) || new RegExp("^-?\\d{1," + (param.integer != null ? param.integer : "") + "}" + (param.fraction != null ? (param.fraction > 0 ? "(\\.\\d{1," + param.fraction + "})?$" : "$") : "(\\.\\d+)?$")).test(value);}, "数值超出范围");
...
jQuery.validator.addMethod("positivezero", function(value, element) {return this.optional(element) || value >= 0;}, "A positivezero number please");
jQuery.validator.addMethod("posInt", function(value, element) {return this.optional(element) ||  /^[1-9]\d*$/.test(value);   }, "只能输入正整数");
jQuery.validator.addMethod("posDouTwo", function(value, element) {return this.optional(element) ||  /^\+?(\d*\.\d{2})$/.test(value);   }, "只能输入正浮点数，保留两位小数");
jQuery.validator.addMethod("posDouSix", function(value, element) {return this.optional(element) ||  /^\+?(\d*\.\d{6})$/.test(value);   }, "只能输入正浮点数，保留六位小数");
jQuery.validator.addMethod("posDou", function(value, element) {return this.optional(element) ||  /^\+?(\d*\.\d+)$/.test(value);   }, "只能输入正浮点数");
jQuery.validator.addMethod("zeroPosDou", function(value, element) {return this.optional(element) ||  /^0\.\d+$/.test(value);   }, "只能输入(0,1)之间的浮点数");