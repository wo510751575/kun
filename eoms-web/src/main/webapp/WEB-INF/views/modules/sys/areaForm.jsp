...
<div class="container">
	...
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">区域地带:</label>
			<div class="controls">
				<form:select path="zone" class="input-medium">
					<form:options items="${fns:getDictList('erp_dict_1')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
			</div>
		</div>
		<div class="control-group">
