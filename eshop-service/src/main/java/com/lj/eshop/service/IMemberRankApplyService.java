...
public interface IMemberRankApplyService {
	 ...
	 * 根据特权申请code查询金额
	 * 
	 * @param memberApplyCode 申请code 方法说明：
	 * @author 林进权 CreateDate: 2017年9月9日
	 *
	 */
	...
	int findMemberRankApplyPageCount(FindMemberRankApplyPage findMemberRankApplyPage) throws TsfaServiceException;
