...
public enum MessageTemplate {
	 ...
	 */
	B_SERVICE_NOT_PARAM_WITHDRAW("提现申请", "您的提现申请已成功，请等待审核吧！", "B"),
	/**
	 * 提现审核成功
	 */
	B_SERVICE_NOT_PARAM_WITHDRAW_SUCCESS("提现申请", "您的提现申请已审核通过，财务将在7-15个工作日为您打款，请留意您的银行卡。", "B"),
	/**
	 * 提现审核失败
	 */
	B_SERVICE_NOT_PARAM_WITHDRAW_FAIL("提现申请", "您申请的提现审核未通过，快去查看吧！", "B"),
	/**
	 * b端 7.开通特权成功发送通知给B端 7.1 标题：开通特权成功 内容：您已成功开通特权，快去免费穿戴商品吧！
	 */
	B_SERVICE_NOT_PARAM_MEMBER_RANK("开通特权成功", "您已成功开通会员，快去商城逛逛吧！", "B"),
	/**
