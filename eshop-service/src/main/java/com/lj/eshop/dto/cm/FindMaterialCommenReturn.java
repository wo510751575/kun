...
/**
 * The Class FindMaterialCommenReturn.
 */
public class FindMaterialCommenReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5031761838849785490L;
	...
	public String toString() {
		...
		builder.append("FindMaterialCommenReturn [code=").append(code)
