...
/**
 * The Class UpdateMaterial.
 */
public class UpdateMaterial implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 2760999060925472153L;
	...
	public String toString() {
		...
		builder.append("UpdateMaterial [code=").append(code)
