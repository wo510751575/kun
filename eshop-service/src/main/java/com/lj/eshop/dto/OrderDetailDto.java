...
public class OrderDetailDto implements Serializable {
	...
	public String toString() {
		return "OrderDetailDto [code=" + code + ", productCode=" + productCode + ", productName=" + productName
				+ ", supplyCode=" + supplyCode + ", supplyName=" + supplyName + ", cnt=" + cnt + ", amt=" + amt
				+ ", salePrice=" + salePrice + ", orderNo=" + orderNo + ", skuCode=" + skuCode + ", orgPrice="
				+ orgPrice + ", gapPrice=" + gapPrice + ", returnCnt=" + returnCnt + ", sku=" + sku + ", product="
				+ product + ", skuDesc=" + skuDesc + ", modelNum=" + modelNum + "]";
	}
