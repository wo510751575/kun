...
public class FindActivityPageReturn implements Serializable {
	 ...
	 /**
	     ...
	     * @throws 
	     */
	private static final long serialVersionUID = -8516896987462806947L; 
	...
	public String toString() {
		...
		builder.append("Activity [code=").append(code).append(", merchantNo=")
				.append(merchantNo).append(", merchantName=")
				.append(merchantName).append(", title=").append(title)
				.append(", content=").append(content).append(", imgAddr=")
				.append(imgAddr).append(", linkUrl=").append(linkUrl)
