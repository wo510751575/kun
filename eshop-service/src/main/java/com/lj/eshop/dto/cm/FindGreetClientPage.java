...
public class FindGreetClientPage extends PageParamEntity {
	...
	public String toString() {
		return "FindGreetClientPage [code=" + code + ", merchantNo=" + merchantNo + ", memberNoGm=" + memberNoGm
				+ ", memberNameGm=" + memberNameGm + ", title=" + title + ", content=" + content + ", sendType="
				+ sendType + ", memberNo=" + memberNo + ", createId=" + createId + ", createDate=" + createDate
