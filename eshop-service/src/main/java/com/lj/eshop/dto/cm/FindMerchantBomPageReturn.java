...
/**
 * The Class FindMerchantBomPageReturn.
 */
public class FindMerchantBomPageReturn implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 720761467028597757L; 
