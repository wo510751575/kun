...
/**
 * The Class FindTextInfoPageReturn.
 */
public class FindTextInfoPageReturn implements Serializable { 
	
	  /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 4983738199253943615L;
	...
	public String toString() {
		...
		builder.append("FindTextInfoPageReturn [code=").append(code)
