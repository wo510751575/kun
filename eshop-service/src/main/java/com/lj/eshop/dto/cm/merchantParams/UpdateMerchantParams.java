...
/**
 * The Class UpdateMerchantParams.
 */
public class UpdateMerchantParams implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6310008953719517703L;
	...
	public String toString() {
		...
		builder.append("UpdateMerchantParams [code=").append(code)
