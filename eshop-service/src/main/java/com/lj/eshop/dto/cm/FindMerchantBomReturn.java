...
/**
 * The Class FindMerchantBomReturn.
 */
public class FindMerchantBomReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 6633996515042487018L;
	...
	public String toString() {
		return "FindMerchantBomReturn [code=" + code + ", merchantNo="
				+ merchantNo + ", merchantName=" + merchantName + ", bomCode="
				+ bomCode + ", bomName=" + bomName + ", imgAddr=" + imgAddr
