...
public class OrderDto implements Serializable {
	...
	public void setMyInviteDto(MemberDto myInviteDto) {
		this.myInviteDto = myInviteDto;
	}

	public ProductGiftDto getProductGiftDto() {
	...
	public String toString() {
		return "OrderDto [code=" + code + ", amt=" + amt + ", mbrCode=" + mbrCode + ", mbrName=" + mbrName
				+ ", mbrPhone=" + mbrPhone + ", mbrType=" + mbrType + ", status=" + status + ", remarks=" + remarks
				+ ", isInvoice=" + isInvoice + ", invoiceTitle=" + invoiceTitle + ", invoiceInfo=" + invoiceInfo
				+ ", createTime=" + createTime + ", updateTime=" + updateTime + ", orderNo=" + orderNo + ", shopCode="
				+ shopCode + ", expressNo=" + expressNo + ", expressName=" + expressName + ", payType=" + payType
				+ ", merchantCode=" + merchantCode + ", shopName=" + shopName + ", startTime=" + startTime
