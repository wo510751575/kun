package com.lj.eshop.dto.cm.merchantParams;

import java.io.Serializable;
import java.util.Date;

/**
 * The Class FindMerchantParamsReturn.
 */
public class FindMerchantParamsReturn implements Serializable { 

    /** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7000745397302881916L;
	...
	public String toString() {
		...
		builder.append("FindMerchantParamsReturn [code=").append(code)
