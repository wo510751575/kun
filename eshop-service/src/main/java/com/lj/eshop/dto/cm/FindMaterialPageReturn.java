...
/**
 * The Class FindMaterialPageReturn.
 */
public class FindMaterialPageReturn implements Serializable {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7924366395400535237L; 
	...
	public String toString() {
		...
		builder.append("FindMaterialPageReturn [code=").append(code)
