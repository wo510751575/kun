...
public class AccWaterDto implements Serializable {
	...
	private String memberAvotor;
	private String memberName;
	private String memberPhone;

	public String getMemberAvotor() {
		return memberAvotor;
	}

	public void setMemberAvotor(String memberAvotor) {
		this.memberAvotor = memberAvotor;
	}
	...
	public String toString() {
		return "AccWaterDto [code=" + code + ", accWaterNo=" + accWaterNo + ", accDate=" + accDate + ", accSource="
				+ accSource + ", accType=" + accType + ", tranOrderNo=" + tranOrderNo + ", amt=" + amt + ", accNo="
				+ accNo + ", status=" + status + ", payType=" + payType + ", beforeAmt=" + beforeAmt + ", afterAmt="
				+ afterAmt + ", bizType=" + bizType + ", updateTime=" + updateTime + ", opCode=" + opCode
				+ ", waterType=" + waterType + ", accCode=" + accCode + ", gapPrice=" + gapPrice + ", productName="
				+ productName + ", memberAvotor=" + memberAvotor + ", memberName=" + memberName + ", memberPhone="
				+ memberPhone + "]";
	}
